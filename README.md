...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
|1. [Origem](https://github.com/renatomenendes/framework_pinhao#1-origem)                                                                                     |4. [Camada visual](https://github.com/renatomenendes/framework_pinhao#4-camada-visual)                 |
|2. [Pré-requisitos](https://github.com/renatomenendes/framework_pinhao#2-pr%C3%A9-requisitos)                                                                |    4.1 [Iconografia](https://github.com/renatomenendes/framework_pinhao#41-iconografia)               |
|    2.1 [Padronização de arquivos de CSV/EXCEL](https://github.com/renatomenendes/framework_pinhao#21-padroniza%C3%A7%C3%A3o-de-arquivos-de-csvexcel)        |    4.2 [Letra](https://github.com/renatomenendes/framework_pinhao#42-letra)                           |
|    2.2 [Padronização da tabela](https://github.com/renatomenendes/framework_pinhao#22-padroniza%C3%A7%C3%A3o-da-tabela)                                     |    4.3 [Cores](https://github.com/renatomenendes/framework_pinhao#43-cores)                           |
|    2.3 [Permissionamento](https://github.com/renatomenendes/framework_pinhao#23-permissionamento)                                                           |    4.4 [Números em Geral](https://github.com/renatomenendes/framework_pinhao#44-n%C3%BAmeros-em-geral)|
|    2.4 [Direcionamento](https://github.com/renatomenendes/framework_pinhao#24-direcionamento)                                                               |5. [Wireframe](https://github.com/renatomenendes/framework_pinhao#5-wireframe)                         |
|3. [Padronização dos arquivos e da (s) tabela(s)](https://github.com/renatomenendes/framework_pinhao#3-padroniza%C3%A7%C3%A3o-dos-arquivos-e-da-s-tabelas)   |                                                                                                                            |
|                                                                                                                                                                                                                                                                                                               |
| <img src="/img/ind3.png">                                                                                                                                                        | <img src="/img/ind4.png">                                                                                                  |
|6. [Arquitetura](https://github.com/renatomenendes/framework_pinhao#6-arquitetura)                                                                           |7. [Documentação](https://github.com/renatomenendes/framework_pinhao#7-documenta%C3%A7%C3%A3o)         |
|    - [Desenvolvimento](https://github.com/renatomenendes/framework_pinhao#devhomol)                                                                         |    7.1 [Controle](https://github.com/renatomenendes/framework_pinhao#71-controle)                     |
|    - [Homologação](https://github.com/renatomenendes/framework_pinhao#devhomol)                                                                             |    7.2 [Cálculos](https://github.com/renatomenendes/framework_pinhao#72-c%C3%A1lculos)                |
|    - [Produção](https://github.com/renatomenendes/framework_pinhao#producao)                                                                                |    7.3 [Especifiçação](https://github.com/renatomenendes/framework_pinhao#73-especifica%C3%A7%C3%A3o) |
|                                                                                                                                                                                  |    7.4 [Evidência](https://github.com/renatomenendes/framework_pinhao#74-evid%C3%AAncia)              |
|                                                                                                                                                                                  |    7.5 [Detalhe Filtro](https://github.com/renatomenendes/framework_pinhao#75-detalhe-filtro)         |
|                                                                                                                                                                                  |    7.6 [Modelagem](https://github.com/renatomenendes/framework_pinhao#76-modelagem)                   |
...
> Link para o [Check List](https://github.com/renatomenendes/framework_pinhao/blob/main/checklist.md)
